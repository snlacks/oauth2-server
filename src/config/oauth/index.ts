...
const redirectUris: any = 'https://localhost:3001/oauthExample/callback,https://localhost:3000,https://localhost:3001,https://localhost:3002,extension://eipdnjedkpcnlmmdfdkgfpljanehloah/app/workspace.html#'.split(',').map((item) => {
    console.log(item)
    return item.trim();
});
