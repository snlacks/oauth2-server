...
Note: this code uses [Yo generator](https://github.com/ChechaValerii/node-typescript-mongodb) built by [Checha Valerii](https://github.com/ChechaValerii), I made some changes to work on my local for my project and then back ported. I hightly recommend you use his tool to scaffold you
